...
**
** Created: Sun Feb 9 15:26:58 2014
...
public:
    ...
    void setupUi(QWidget *PaletteDlg)
    {
        ...
        MTActiveRadio = new QRadioButton(MatTypeGroup);
        MTActiveRadio->setObjectName(QString::fromUtf8("MTActiveRadio"));

        horizontalLayout_4->addWidget(MTActiveRadio);
    ...
    void retranslateUi(QWidget *PaletteDlg)
    {
        ...
        MTActiveRadio->setText(QApplication::translate("PaletteDlg", "Active", 0, QApplication::UnicodeUTF8));
